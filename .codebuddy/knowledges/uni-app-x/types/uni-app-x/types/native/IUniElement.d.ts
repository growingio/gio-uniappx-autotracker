import { DrawableContext } from "./index"
import { TakeSnapshotOptions } from "./index"
import { UniEvent } from "./UniEvent"
import { CSSStyleDeclaration } from "./CSSStyleDeclaration"
import { DOMRect } from "./index"
import { UniCallbackWrapper } from "./UniCallbackWrapper"
import { CanvasRenderingContext2D } from "./CanvasRenderingContext2D"
import { UniAnimation } from "./index"
...
/**
 * nested-scroll-header 组件的 DOM 元素对象。
 * @package io.dcloud.uniapp.runtime
 * @uniPlatform {
 *    "app": {
 *        "android": {
...
/**
 * nested-scroll-body 组件的 DOM 元素对象。
 * @package io.dcloud.uniapp.runtime
 * @uniPlatform {
 *    "app": {
 *        "android": {
...
/**
 * share-element 组件（共享元素）的 DOM 元素对象。
 * @package io.dcloud.uniapp.runtime
 * @uniPlatform {
 *    "app": {
 *        "android": {
