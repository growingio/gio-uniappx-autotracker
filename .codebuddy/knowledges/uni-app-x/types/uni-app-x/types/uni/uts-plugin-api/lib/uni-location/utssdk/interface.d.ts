...
export interface Uni {
     ...
     *	});
     * ```
     * @tutorial https://doc.dcloud.net.cn/uni-app-x/api/get-location.html
     * @tutorial_uni_app_x https://doc.dcloud.net.cn/uni-app-x/api/get-location.html
     * @tutorial_uni_app http://uniapp.dcloud.io/api/location/location?id=getlocation
     * @uniPlatform {
     *   "app": {
     *     "android": {
     *       "osVer": "5.0",
