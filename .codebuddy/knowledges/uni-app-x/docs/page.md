...
| 组合式 | 选项式 | Web | 微信小程序 | Android | Android(Vapor) | iOS | iOS(Vapor) | HarmonyOS | HarmonyOS(Vapor) | 描述 |
| :- | :- | :- | :- | :- | :- | :- | :- | :- | :- | :- |
| onLoad | onLoad | 4.0 | 4.41 | 3.9 | - | 4.11 | - | 4.61 | 5.0 | 生命周期回调 监听页面加载<br/><br/>页面加载时触发。一个页面只会调用一次，可以在 onLoad 的参数中获取打开当前页面路径中的参数。 |
| onPageShow | onShow | 4.0 | 4.41 | 3.9 | - | 4.11 | - | 4.61 | 5.0 | 生命周期回调 监听页面显示<br/><br/>页面显示/切入前台时触发。<br/> |
| onReady | onReady | 4.0 | 4.41 | 3.9 | - | 4.11 | - | 4.61 | 5.0 | 生命周期回调 监听页面初次渲染完成<br/><br/>页面初次渲染完成时触发。一个页面只会调用一次，代表页面已经准备妥当，可以和视图层进行交互。<br/> |
| onPageHide | onHide | 4.0 | 4.41 | 3.9 | - | 4.11 | - | 4.61 | 5.0 | 生命周期回调 监听页面隐藏<br/><br/>页面隐藏/切入后台时触发。 如 `navigateTo` 或底部 `tab` 切换到其他页面，应用切入后台等。<br/> |
| onUnload | onUnload | 4.0 | 4.41 | 3.9 | - | 4.11 | - | 4.61 | 5.0 | 生命周期回调 监听页面卸载<br/><br/>页面卸载时触发。如 `redirectTo` 或 `navigateBack` 到其他页面时。<br/> |
| onPullDownRefresh | onPullDownRefresh | 4.0 | 4.41 | 3.9 | - | 4.11 | - | 4.61 | x | 监听用户下拉动作<br/>- 需要在 `pages.json` 的页面配置中开启 `enablePullDownRefresh` 。<br/>- 可以通过 `uni.startPullDownRefresh` 触发下拉刷新，调用后触发下拉刷新动画，效果与用户手动下拉刷新一致。<br/>- 当处理完数据刷新后，`uni.stopPullDownRefresh` 可以停止当前页面的下拉刷新。<br/> |
| onReachBottom | onReachBottom | 4.0 | 4.41 | 3.9 | - | 4.11 | - | 4.61 | 5.08 | 页面上拉触底事件的处理函数<br/>- 可以在 `pages.json` 的页面配置中设置触发距离 `onReachBottomDistance` 。<br/>- 在触发距离内滑动期间，本事件只会被触发一次。<br/> |
| onPageScroll | onPageScroll | 4.0 | 4.41 | 3.9 | - | 4.13 | - | 4.61 | 5.08 | 页面滚动触发事件的处理函数<br/><br/>监听用户滑动页面事件。 |
| onResize | onResize | 4.0 | 4.41 | 3.9 | - | 4.11 | - | 4.61 | x | 页面尺寸改变时触发 |
| onBackPress | onBackPress | 4.0 | x | 3.9 | - | 4.11 | - | 4.61 | 5.0 | 监听页面返回 |
| onInit | onInit | x | x | x | - | x | - | 4.61 | x | 生命周期回调 监听页面初始化<br/><br/>页面初始化时触发。一个页面只会调用一次，可以在 onInit 的参数中获取打开当前页面路径中的参数。 |
| onShareAppMessage | onShareAppMessage | x | 4.41 | x | - | x | - | 4.61 | x | 用户点击右上角转发<br/><br/>监听用户点击页面内转发按钮（`<button>` 组件 `open-type="share"`）或右上角菜单“转发”按钮的行为，并自定义转发内容。 |
| onShareTimeline | onShareTimeline | x | 4.41 | x | - | x | - | 4.61 | x | 用户点击右上角转发到朋友圈<br/><br/>监听右上角菜单“分享到朋友圈”按钮的行为，并自定义发享内容。<br/> |
| onAddToFavorites | onAddToFavorites | x | 4.41 | x | - | x | - | 4.61 | x | 用户点击右上角收藏<br/><br/>监听用户点击右上角菜单“收藏”按钮的行为，并自定义收藏内容。<br/> |
...
| onNavigationBarSearchInputChanged | onNavigationBarSearchInputChanged | 4.0 | x | x | - | x | - | 4.61 | x | 监听原生标题栏搜索输入框输入内容变化事件<br/> |
| onNavigationBarSearchInputConfirmed | onNavigationBarSearchInputConfirmed | 4.0 | x | x | - | x | - | 4.61 | x | 监听原生标题栏搜索输入框搜索事件，用户点击软键盘上的“搜索”按钮时触发。<br/> |
| onNavigationBarSearchInputClicked | onNavigationBarSearchInputClicked | 4.0 | x | x | - | x | - | 4.61 | x | 监听原生标题栏搜索输入框点击事件<br/> |
...
| 名称 | 类型 | 必填 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| options | **OnResizeOptions** | 是 | - | Web: 4.0; 微信小程序: 4.41; Android: 3.9; Android(Vapor): -; iOS: 4.11; iOS(Vapor): -; HarmonyOS: 4.61; HarmonyOS(Vapor): x | 页面尺寸改变时回调参数  |

#### options 的属性描述

| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| deviceOrientation | string | 是 | - | Web: 4.0; 微信小程序: 4.41; Android: 3.9; Android(Vapor): -; iOS: 4.11; iOS(Vapor): -; HarmonyOS: 4.61; HarmonyOS(Vapor): x | 屏幕方向 |
| size | **OnResizeSize** | 是 | - | Web: 4.0; 微信小程序: 4.41; Android: 3.9; Android(Vapor): -; iOS: 4.11; iOS(Vapor): -; HarmonyOS: 4.61; HarmonyOS(Vapor): x | 新的显示区域尺寸 |

##### size 的属性描述

| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| screenHeight | number | 是 | - | Web: 4.0; 微信小程序: 4.41; Android: 3.9; Android(Vapor): -; iOS: 4.11; iOS(Vapor): -; HarmonyOS: 4.61; HarmonyOS(Vapor): x | 新的屏幕高度 |
| screenWidth | number | 是 | - | Web: 4.0; 微信小程序: 4.41; Android: 3.9; Android(Vapor): -; iOS: 4.11; iOS(Vapor): -; HarmonyOS: 4.61; HarmonyOS(Vapor): x | 新的屏幕宽度 |
| windowHeight | number | 是 | - | Web: 4.0; 微信小程序: 4.41; Android: 3.9; Android(Vapor): -; iOS: 4.11; iOS(Vapor): -; HarmonyOS: 4.61; HarmonyOS(Vapor): x | 新的显示区域高度 |
| windowWidth | number | 是 | - | Web: 4.0; 微信小程序: 4.41; Android: 3.9; Android(Vapor): -; iOS: 4.11; iOS(Vapor): -; HarmonyOS: 4.61; HarmonyOS(Vapor): x | 新的显示区域宽度 | 
...
| 名称 | 类型 | 必填 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| options | **OnPageScrollOptions** | 是 | - | Web: 4.0; 微信小程序: 4.41; Android: 3.9; Android(Vapor): -; iOS: 4.13; iOS(Vapor): -; HarmonyOS: 4.61; HarmonyOS(Vapor): 5.08 | 页面滚动参数 |

#### options 的属性描述

| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| scrollTop | number | 是 | - | Web: 4.0; 微信小程序: 4.41; Android: 3.9; Android(Vapor): -; iOS: 4.13; iOS(Vapor): -; HarmonyOS: 4.61; HarmonyOS(Vapor): x | 页面在垂直方向已滚动的距离（单位 px） | 
...
| 名称 | 类型 | 必填 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| options | **OnBackPressOptions** | 是 | - | Web: 4.0; 微信小程序: x; Android: 3.9; Android(Vapor): -; iOS: 4.11; iOS(Vapor): -; HarmonyOS: 4.61; HarmonyOS(Vapor): 5.0 | 监听页面返回回调参数  |

#### options 的属性描述

| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| from | string | 是 | - | Web: 4.0; 微信小程序: x; Android: 3.9; Android(Vapor): -; iOS: 4.11; iOS(Vapor): -; HarmonyOS: 4.61; HarmonyOS(Vapor): 5.0 | - backbutton 顶部导航栏左边的返回按钮或 Android 实体返回键<br/>- navigateBack 返回 API，即 uni.navigateBack() |

##### from 的属性描述

| 合法值 | 兼容性 | 描述 |
| :- |  :-: | :- |
| backbutton | Web: -; 微信小程序: x; Android: -; Android(Vapor): -; iOS: -; iOS(Vapor): -; HarmonyOS: -; HarmonyOS(Vapor): - | - |
| navigateBack | Web: -; 微信小程序: x; Android: -; Android(Vapor): -; iOS: -; iOS(Vapor): -; HarmonyOS: -; HarmonyOS(Vapor): - | - | 
...
| 名称 | 类型 | 必填 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| options | **OnTabItemTapOption** | 是 | - | Web: 4.0; 微信小程序: 4.41; Android: x; Android(Vapor): -; iOS: x; iOS(Vapor): -; HarmonyOS: 4.61; HarmonyOS(Vapor): x | 监听 tab 点击回调参数 |

#### options 的属性描述

| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| index | number | 是 | - | Web: 4.0; 微信小程序: 4.41; Android: x; Android(Vapor): -; iOS: x; iOS(Vapor): -; HarmonyOS: 4.61; HarmonyOS(Vapor): x | 被点击 tabItem 的序号，从0开始 |
| pagePath | string | 是 | - | Web: 4.0; 微信小程序: 4.41; Android: x; Android(Vapor): -; iOS: x; iOS(Vapor): -; HarmonyOS: 4.61; HarmonyOS(Vapor): x | 被点击 tabItem 的页面路径 |
| text | string | 是 | - | Web: 4.0; 微信小程序: 4.41; Android: x; Android(Vapor): -; iOS: x; iOS(Vapor): -; HarmonyOS: 4.61; HarmonyOS(Vapor): x | 被点击 tabItem 的按钮文字 | 
...
| 名称 | 类型 | 必填 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| options | **OnNavigationBarButtonTapOption** | 是 | - | Web: 4.0; 微信小程序: x; Android: x; Android(Vapor): -; iOS: x; iOS(Vapor): -; HarmonyOS: 4.61; HarmonyOS(Vapor): x | 原生标题栏按钮点击回调参数  |

#### options 的属性描述

| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| index | number | 是 | - | Web: 4.0; 微信小程序: x; Android: x; Android(Vapor): -; iOS: x; iOS(Vapor): -; HarmonyOS: 4.61; HarmonyOS(Vapor): x | 原生标题栏按钮数组的下标 | 
...
| 名称 | 类型 | 必填 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| event | **NavigationBarSearchInputEvent** | 是 | - | Web: 4.0; 微信小程序: x; Android: x; Android(Vapor): -; iOS: x; iOS(Vapor): -; HarmonyOS: 4.61; HarmonyOS(Vapor): x | 监听原生标题栏搜索输入框搜索回调参数  |

#### event 的属性描述

| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| text | string | 是 | - | Web: 4.0; 微信小程序: x; Android: x; Android(Vapor): -; iOS: x; iOS(Vapor): -; HarmonyOS: 4.61; HarmonyOS(Vapor): x | 搜索输入框输入内容 | 
