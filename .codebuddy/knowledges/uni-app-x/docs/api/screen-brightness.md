...
| :- | :- | :- | :- | :- | :- |
| <a style="color:unset;" href="https://vote.dcloud.net.cn/#/?name=uni-app%20x">x</a> | 4.41 | 5.08 | 5.08 | 4.81 | 5.0 |
...
| 名称 | 类型 | 必填 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| options | **GetScreenBrightnessOptions** | 是 | - | Web: x; 微信小程序: -; Android: -; iOS: -; HarmonyOS: - | 获取屏幕亮度的参数 |

#### options 的属性描述

| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| success | (result: [GetScreenBrightnessSuccess](#getscreenbrightnesssuccess-values)) => void | 否 | - | Web: x; 微信小程序: 4.41; Android: 5.08; iOS: 5.08; HarmonyOS: 4.81; HarmonyOS(Vapor): 5.0 | 成功返回的回调函数 |
| fail | (result: [GetScreenBrightnessFail](#getscreenbrightnessfail-values)) => void | 否 | - | Web: x; 微信小程序: 4.41; Android: 5.08; iOS: 5.08; HarmonyOS: 4.81; HarmonyOS(Vapor): 5.0 | 失败的回调函数 |
| complete | (result: [GetScreenBrightnessSuccess](#getscreenbrightnesssuccess-values) \| [GetScreenBrightnessFail](#getscreenbrightnessfail-values)) => void | 否 | - | Web: x; 微信小程序: 4.41; Android: 5.08; iOS: 5.08; HarmonyOS: 4.81; HarmonyOS(Vapor): 5.0 | 结束的回调函数（调用成功、失败都会执行） | 

#### GetScreenBrightnessSuccess 的属性值 @getscreenbrightnesssuccess-values 

| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| value | number | 是 | - | Web: x; 微信小程序: 4.41; Android: 5.08; iOS: 5.08; HarmonyOS: 4.81; HarmonyOS(Vapor): 5.0 | 屏幕亮度值，范围 0~1，0 最暗，1 最亮。 |
...
| 名称 | 类型 | 必填 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| options | **SetScreenBrightnessOptions** | 是 | - | Web: x; 微信小程序: -; Android: -; iOS: -; HarmonyOS: - | 设置屏幕亮度的参数 |
...
| :- | :- | :- | :- |  :-: | :- |
| value | number | 是 | - | Web: x; 微信小程序: 4.41; Android: 5.08; iOS: 5.08; HarmonyOS: 4.81; HarmonyOS(Vapor): 5.0 | 屏幕亮度值，范围 0~1，0 最暗，1 最亮 |
| success | (result: SetScreenBrightnessSuccess) => void | 否 | - | Web: x; 微信小程序: 4.41; Android: 5.08; iOS: 5.08; HarmonyOS: 4.81; HarmonyOS(Vapor): 5.0 | 接口调用成功的回调函数 |
| fail | (result: [SetScreenBrightnessFail](#setscreenbrightnessfail-values)) => void | 否 | - | Web: x; 微信小程序: 4.41; Android: 5.08; iOS: 5.08; HarmonyOS: 4.81; HarmonyOS(Vapor): 5.0 | 接口调用失败的回调函数 |
| complete | (result: SetScreenBrightnessSuccess \| [SetScreenBrightnessFail](#setscreenbrightnessfail-values)) => void | 否 | - | Web: x; 微信小程序: 4.41; Android: 5.08; iOS: 5.08; HarmonyOS: 4.81; HarmonyOS(Vapor): 5.0 | 接口调用结束的回调函数（调用成功、失败都会执行） | 
...
| 名称 | 类型 | 必填 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| options | **SetKeepScreenOnOptions** | 是 | - | Web: -; 微信小程序: -; Android: -; iOS: -; HarmonyOS: - | 设置是否保持常亮状态的参数 |

#### options 的属性描述

| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| keepScreenOn | boolean | 是 | - | Web: 5.08; 微信小程序: 4.41; Android: 5.08; iOS: 5.08; HarmonyOS: 4.81; HarmonyOS(Vapor): 5.0 | 是否保持屏幕常亮 |
| success | (result: [SetKeepScreenOnSuccess](#setkeepscreenonsuccess-values)) => void | 否 | - | Web: 5.08; 微信小程序: 4.41; Android: 5.08; iOS: 5.08; HarmonyOS: 4.81; HarmonyOS(Vapor): 5.0 | 接口调用成功的回调函数 |
| fail | (result: [SetKeepScreenOnFail](#setkeepscreenonfail-values)) => void | 否 | - | Web: 5.08; 微信小程序: 4.41; Android: 5.08; iOS: 5.08; HarmonyOS: 4.81; HarmonyOS(Vapor): 5.0 | 接口调用失败的回调函数 |
| complete | (result: [SetKeepScreenOnSuccess](#setkeepscreenonsuccess-values) \| [SetKeepScreenOnFail](#setkeepscreenonfail-values)) => void | 否 | - | Web: 5.08; 微信小程序: 4.41; Android: 5.08; iOS: 5.08; HarmonyOS: 4.81; HarmonyOS(Vapor): 5.0 | 接口调用结束的回调函数（调用成功、失败都会执行） | 

#### SetKeepScreenOnSuccess 的属性值 @setkeepscreenonsuccess-values 

| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| errMsg | string | 是 | - | Web: 5.08; 微信小程序: 4.41; Android: 5.08; iOS: 5.08; HarmonyOS: 4.81; HarmonyOS(Vapor): 5.0 | 调用结果 |
