...
| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| provider | string | 否 | - | Web: x; 微信小程序: x; Android: 5.08; iOS: 5.08; HarmonyOS: 4.61; HarmonyOS(Vapor): 5.0 | 授权登录服务提供商，通过uni.getProvider获取，如果不设置则弹出分享列表选择界面<br/> |
...
| onlyAuthorize | boolean | 否 | - | Web: x; 微信小程序: -; Android: 5.08; iOS: 5.08; HarmonyOS: 4.81; HarmonyOS(Vapor): 5.0 | 微信登录仅请求授权认证<br/> |
...
| 合法值 | 兼容性 | 描述 |
| :- |  :-: | :- |
| weixin | Web: x; 微信小程序: -; Android: 5.08; iOS: 5.08; HarmonyOS: 4.81; HarmonyOS(Vapor): 5.0 | 微信登录 |
...
| authResult | any | 是 | - | Web: x; 微信小程序: -; Android: 5.08; iOS: 5.08; HarmonyOS: 4.61; HarmonyOS(Vapor): 5.0 | 登录服务商提供的登录信息，服务商不同返回的结果不完全相同 |
| code | string | 是 | - | Web: x; 微信小程序: -; Android: 5.08; iOS: 5.08; HarmonyOS: 4.61; HarmonyOS(Vapor): 5.0 | 小程序用户临时登录凭证 |
...
| gender | string | 否 | - | Web: x; 微信小程序: x; Android: x; iOS: x; HarmonyOS: 4.81; HarmonyOS(Vapor): 5.0 | 用户性别（仅微信登录支持） |
