...
- [uni-ui x](https://gitcode.com/dcloud/uni-ui-x)：官方UI库。未测试HBuilderX 5.07之前的版本兼容性。
...
- [Pinia by uts](https://ext.dcloud.net.cn/plugin?id=27734)：TMUI作者提供的pinia的uts版。
...
3. 对于css，如果你之前使用nvue的css，那么迁移到uni-app x在样式上改动很小。如果之前是vue的css，那么需要改为flex布局，以及仅使用uvue支持的css来布局界面。
