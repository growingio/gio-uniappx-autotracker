...
| 名称 | 类型 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| @init | (event: [UniNativeViewInitEvent](#uninativeviewinitevent)) => void | - | Web: x; 微信小程序: x; Android: 4.31; Android(Vapor): -; iOS: 4.31; iOS(Vapor): -; HarmonyOS: 4.61; HarmonyOS(Vapor): 5.0 | native-view初始化时回调，event.detail = { element: 'native-view元素实例对象'} |
