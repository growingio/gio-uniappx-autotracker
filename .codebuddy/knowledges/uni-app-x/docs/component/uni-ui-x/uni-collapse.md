...
<template>
  <scroll-view class="page">
    ...
    <view class="section section-dark">
      ...
      <uni-collapse :accordion="false">
        <uni-collapse-item class="dark-collapse-item" title="暗色标题 A" :open="true" title-wrap-class="dark-title-wrap" title-class="dark-title-text" title-open-class="dark-title-text-open" arrow-class="dark-arrow" arrow-open-class="dark-arrow-open">
        ...
        <uni-collapse-item class="dark-collapse-item dark-collapse-item-strong" title="暗色标题 B" title-wrap-class="dark-title-wrap-strong" title-class="dark-title-text-strong" title-open-class="dark-title-text-open" arrow-class="dark-arrow-strong" arrow-open-class="dark-arrow-open">
          <view class="content-box dark-content-box">
            <text class="content-text dark-content-text">你也可以继续组合不同的根容器 class、标题字重、箭头粗细和激活色样式。</text>
          </view>
        </uni-collapse-item>
        <uni-collapse-item class="dark-collapse-item dark-collapse-item-muted" title="暗色禁用项" :disabled="true" title-wrap-class="dark-title-wrap-muted" title-class="dark-title-text" title-disabled-class="dark-title-text-disabled" arrow-class="dark-arrow" arrow-disabled-class="dark-arrow-disabled">
...
| titleWrapClass | classString | "" | - | 标题行（整行容器）的样式类 |
| titleClass | classString | "" | - | 标题文字的基础样式类 |
| titleOpenClass | classString | "" | - | 展开状态下叠加到标题文字的样式类 |
| titleDisabledClass | classString | "" | - | 禁用状态下叠加到标题文字的样式类 |
| contentWrapClass | classString | "" | - | 内容外层容器的样式类 |
| arrowClass | classString | "" | - | 箭头图标的基础样式类 |
| arrowOpenClass | classString | "" | - | 展开状态下叠加到箭头图标的样式类 |
| arrowDisabledClass | classString | "" | - | 禁用状态下叠加到箭头图标的样式类 |
| @change | Event | - | - | - |
