...
| 名称 | 类型 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| paused | boolean | false | Web: 5.0; 微信小程序: 5.0; Android: 5.0; Android(Vapor): -; iOS: 5.0; iOS(Vapor): -; HarmonyOS: 5.0; HarmonyOS(Vapor): 5.0 | 是否暂停动画 |
| bold | boolean | false | Web: 5.0; 微信小程序: x; Android: 5.0; Android(Vapor): -; iOS: 5.0; iOS(Vapor): -; HarmonyOS: 5.0; HarmonyOS(Vapor): 5.0 | 是否加粗线条 |
| ios-spinner | boolean | false | Web: x; 微信小程序: x; Android: x; Android(Vapor): -; iOS: 5.0; iOS(Vapor): 5.0; HarmonyOS: x; HarmonyOS(Vapor): x | iOS是否采用系统雪花状样式 |
