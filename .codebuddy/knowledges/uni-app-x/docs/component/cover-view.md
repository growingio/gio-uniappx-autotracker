...
| 名称 | 类型 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| scroll-top | number/string | - | Web: 4.0; 微信小程序: 4.41; Android: x; Android(Vapor): -; iOS: x; iOS(Vapor): -; HarmonyOS: x; HarmonyOS(Vapor): - | *(number/string)*<br/>设置顶部滚动偏移量，仅在设置了 overflow-y: scroll 成为滚动元素后生效 |
