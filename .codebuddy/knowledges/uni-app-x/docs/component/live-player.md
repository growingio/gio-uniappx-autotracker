...
| 名称 | 类型 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| src | string([string.VideoURIString](/uts/data-type.md#ide-string)) | - | Web: x; 微信小程序: 4.41; Android: 4.81; Android(Vapor): -; iOS: 4.81; iOS(Vapor): -; HarmonyOS: -; HarmonyOS(Vapor): - | 音视频地址。微信小程序支持 flv, rtmp 格式，app平台支持 rtmp, hls 协议 |
| mode | string | - | Web: x; 微信小程序: 4.41; Android: x; Android(Vapor): -; iOS: x; iOS(Vapor): -; HarmonyOS: -; HarmonyOS(Vapor): - | live（直播），RTC（实时通话） |
| autoplay | boolean | false | Web: x; 微信小程序: 4.41; Android: 4.81; Android(Vapor): -; iOS: 4.81; iOS(Vapor): -; HarmonyOS: -; HarmonyOS(Vapor): - | 自动播放 |
...
| object-fit | string | "contain" | Web: x; 微信小程序: 4.41; Android: 4.81; Android(Vapor): -; iOS: 4.81; iOS(Vapor): -; HarmonyOS: -; HarmonyOS(Vapor): - | 填充模式，可选值有 contain，fillCrop |
...
| min-cache | string | - | Web: x; 微信小程序: 4.41; Android: x; Android(Vapor): -; iOS: x; iOS(Vapor): -; HarmonyOS: -; HarmonyOS(Vapor): - | 最小缓冲区，单位s |
| max-cache | string | - | Web: x; 微信小程序: 4.41; Android: x; Android(Vapor): -; iOS: x; iOS(Vapor): -; HarmonyOS: -; HarmonyOS(Vapor): - | 最大缓冲区，单位s |
| sound-mode | string | - | Web: x; 微信小程序: 4.41; Android: x; Android(Vapor): -; iOS: x; iOS(Vapor): -; HarmonyOS: x; HarmonyOS(Vapor): - | *(string)*<br/>声音输出方式 |
| auto-pause-if-navigate | boolean | - | Web: x; 微信小程序: 4.41; Android: x; Android(Vapor): -; iOS: x; iOS(Vapor): -; HarmonyOS: x; HarmonyOS(Vapor): - | *(boolean)*<br/>当跳转到本小程序的其他页面时，是否自动暂停本页面的实时音视频播放 |
| auto-pause-if-open-native | boolean | - | Web: x; 微信小程序: 4.41; Android: x; Android(Vapor): -; iOS: x; iOS(Vapor): -; HarmonyOS: x; HarmonyOS(Vapor): - | *(boolean)*<br/>当跳转到其它微信原生页面时，是否自动暂停本页面的实时音视频播放 |
...
| enable-casting | boolean | - | Web: x; 微信小程序: 4.41; Android: x; Android(Vapor): -; iOS: x; iOS(Vapor): -; HarmonyOS: x; HarmonyOS(Vapor): - | *(boolean)*<br/>是否支持投屏。开启后，可以通过 [LivePlayerContext]((LivePlayerContext)) 上相关方法进行操作。 |
| @statechange | (event: [UniLivePlayerStatechangeEvent](#uniliveplayerstatechangeevent)) => void | - | Web: x; 微信小程序: 4.41; Android: 4.81; Android(Vapor): -; iOS: 4.81; iOS(Vapor): -; HarmonyOS: -; HarmonyOS(Vapor): - | 播放状态变化事件，event.detail = {code} |
| @fullscreenchange | (event: [UniLivePlayerFullscreenchangeEvent](#uniliveplayerfullscreenchangeevent)) => void | - | Web: x; 微信小程序: 4.41; Android: 4.81; Android(Vapor): -; iOS: 4.81; iOS(Vapor): -; HarmonyOS: -; HarmonyOS(Vapor): - | 全屏变化事件，event.detail = {direction, fullScreen} |
| @error | (event: [UniLivePlayerErrorEvent](#uniliveplayererrorevent)) => void | - | Web: x; 微信小程序: x; Android: 4.81; Android(Vapor): -; iOS: 4.81; iOS(Vapor): -; HarmonyOS: -; HarmonyOS(Vapor): - | 错误事件，event.detail = {errCode, errMsg} |
...
| @audiovolumenotify | eventhandler | - | Web: x; 微信小程序: 4.41; Android: x; Android(Vapor): -; iOS: x; iOS(Vapor): -; HarmonyOS: x; HarmonyOS(Vapor): - | *(eventhandler)*<br/>播放音量大小通知，detail = {} |
...
| live | Web: x; 微信小程序: 4.41; Android: x; Android(Vapor): -; iOS: x; iOS(Vapor): -; HarmonyOS: x; HarmonyOS(Vapor): - | - |
...
| 合法值 | 兼容性 | 描述 |
| :- |  :-: | :- |
| contain | Web: x; 微信小程序: 4.41; Android: 4.81; Android(Vapor): -; iOS: 4.81; iOS(Vapor): -; HarmonyOS: x; HarmonyOS(Vapor): - | - |
| fillCrop | Web: x; 微信小程序: 4.41; Android: 4.81; Android(Vapor): -; iOS: 4.81; iOS(Vapor): -; HarmonyOS: x; HarmonyOS(Vapor): - | - |

#### sound-mode 的属性描述

| 合法值 | 兼容性 | 描述 |
| :- |  :-: | :- |
| speaker | Web: x; 微信小程序: 4.41; Android: x; Android(Vapor): -; iOS: x; iOS(Vapor): -; HarmonyOS: x; HarmonyOS(Vapor): - | 扬声器 |
| ear | Web: x; 微信小程序: 4.41; Android: x; Android(Vapor): -; iOS: x; iOS(Vapor): -; HarmonyOS: x; HarmonyOS(Vapor): - | 听筒 |
...
| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| direction | string | 是 | - | Web: x; 微信小程序: x; Android: 4.81; Android(Vapor): -; iOS: 4.81; iOS(Vapor): -; HarmonyOS: x; HarmonyOS(Vapor): - | 屏幕方向 |
| fullScreen | boolean | 是 | - | Web: x; 微信小程序: x; Android: 4.81; Android(Vapor): -; iOS: 4.81; iOS(Vapor): -; HarmonyOS: x; HarmonyOS(Vapor): - | 是否全屏 |
