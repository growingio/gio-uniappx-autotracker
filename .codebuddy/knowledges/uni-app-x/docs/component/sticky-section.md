...
### 兼容性
| Web | 微信小程序 | Android | Android(Vapor) | iOS | iOS(Vapor) | HarmonyOS 系统版本 | HarmonyOS | HarmonyOS(Vapor) |
| :- | :- | :- | :- | :- | :- | :- | :- | :- |
...
| 名称 | 类型 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| push-pinned-header | boolean | true | Web: x; 微信小程序: x; Android: 3.98; Android(Vapor): -; iOS: 4.11; iOS(Vapor): -; HarmonyOS: x; HarmonyOS(Vapor): - | sticky-section元素重叠时是否继续上推 |
| padding | Array\<number> | [0,0,0,0\] | Web: 4.02; 微信小程序: x; Android: 3.98; Android(Vapor): -; iOS: 4.11; iOS(Vapor): -; HarmonyOS: x; HarmonyOS(Vapor): - | 长度为 4 的数组，按 top、right、bottom、left 顺序指定内边距  |
