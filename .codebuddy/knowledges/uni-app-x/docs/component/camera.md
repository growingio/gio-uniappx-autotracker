...
| 名称 | 类型 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| flash | auto \| on \| off \| torch | - | Web: x; 微信小程序: 4.41; Android: 4.61; Android(Vapor): -; iOS: 4.61; iOS(Vapor): -; HarmonyOS: -; HarmonyOS(Vapor): - | 闪光灯，值为auto, on, off, torch |
| device-position | back \| front | - | Web: x; 微信小程序: 4.41; Android: 4.61; Android(Vapor): -; iOS: 4.61; iOS(Vapor): -; HarmonyOS: -; HarmonyOS(Vapor): - | 前置或后置，值为front, back |
| mode | normal \| scanCode | - | Web: x; 微信小程序: 4.41; Android: 4.71; Android(Vapor): -; iOS: 4.71; iOS(Vapor): -; HarmonyOS: x; HarmonyOS(Vapor): - | *(string)*<br/>应用模式，只在初始化时有效，不能动态变更 |
| resolution | low \| medium \| high | - | Web: x; 微信小程序: 4.41; Android: 4.61; Android(Vapor): -; iOS: 4.61; iOS(Vapor): -; HarmonyOS: x; HarmonyOS(Vapor): - | *(string)*<br/>分辨率，不支持动态修改 |
| frame-size | small \| medium \| large | - | Web: x; 微信小程序: 4.41; Android: 4.61; Android(Vapor): -; iOS: 4.61; iOS(Vapor): -; HarmonyOS: x; HarmonyOS(Vapor): - | *(string)*<br/>指定期望的相机帧数据尺寸 |
| photo-resolution | low \| medium \| high \| original | - | Web: x; 微信小程序: x; Android: 4.81; Android(Vapor): -; iOS: x; iOS(Vapor): -; HarmonyOS: x; HarmonyOS(Vapor): - | *(string)*<br/>指定期望的拍照图片分辨率，不支持动态修改 |
| @stop | (event: [UniCameraStopEvent](#unicamerastopevent)) => void | - | Web: x; 微信小程序: 4.41; Android: 4.61; Android(Vapor): -; iOS: 4.61; iOS(Vapor): -; HarmonyOS: -; HarmonyOS(Vapor): - | 摄像头在非正常终止时触发，如退出后台等情况 |
| @error | (event: [UniCameraErrorEvent](#unicameraerrorevent)) => void | - | Web: x; 微信小程序: 4.41; Android: 4.61; Android(Vapor): -; iOS: 4.61; iOS(Vapor): -; HarmonyOS: -; HarmonyOS(Vapor): - | 用户不允许使用摄像头时触发 |
| @initdone | (event: [UniCameraInitDoneEvent](#unicamerainitdoneevent)) => void | - | Web: x; 微信小程序: 4.41; Android: 4.61; Android(Vapor): -; iOS: 4.61; iOS(Vapor): -; HarmonyOS: x; HarmonyOS(Vapor): - | *(eventhandle)*<br/>相机初始化完成时触发，`e.detail = {maxZoom}` |
| @scancode | (event: [UniCameraScanCodeEvent](#unicamerascancodeevent)) => void | - | Web: x; 微信小程序: 4.41; Android: 4.71; Android(Vapor): -; iOS: 4.71; iOS(Vapor): -; HarmonyOS: x; HarmonyOS(Vapor): - | *(eventhandle)*<br/>在扫码识别成功时触发，仅在 mode="scanCode" 时生效 |

#### flash 的属性描述

| 合法值 | 兼容性 | 描述 |
| :- |  :-: | :- |
| auto | Web: x; 微信小程序: 4.41; Android: 4.61; Android(Vapor): -; iOS: 4.61; iOS(Vapor): -; HarmonyOS: x; HarmonyOS(Vapor): - | 自动 |
| on | Web: x; 微信小程序: 4.41; Android: 4.61; Android(Vapor): -; iOS: 4.61; iOS(Vapor): -; HarmonyOS: x; HarmonyOS(Vapor): - | 开 |
| off | Web: x; 微信小程序: 4.41; Android: 4.61; Android(Vapor): -; iOS: 4.61; iOS(Vapor): -; HarmonyOS: x; HarmonyOS(Vapor): - | 关 |
| torch | Web: x; 微信小程序: 4.41; Android: 4.61; Android(Vapor): -; iOS: 4.61; iOS(Vapor): -; HarmonyOS: x; HarmonyOS(Vapor): - | 常亮 |

#### device-position 的属性描述

| 合法值 | 兼容性 | 描述 |
| :- |  :-: | :- |
| back | Web: x; 微信小程序: 4.41; Android: 4.61; Android(Vapor): -; iOS: 4.61; iOS(Vapor): -; HarmonyOS: x; HarmonyOS(Vapor): - | 后置 |
| front | Web: x; 微信小程序: 4.41; Android: 4.61; Android(Vapor): -; iOS: 4.61; iOS(Vapor): -; HarmonyOS: x; HarmonyOS(Vapor): - | 前置 |

#### mode 的属性描述

| 合法值 | 兼容性 | 描述 |
| :- |  :-: | :- |
| normal | Web: x; 微信小程序: 4.41; Android: 4.71; Android(Vapor): -; iOS: 4.71; iOS(Vapor): -; HarmonyOS: x; HarmonyOS(Vapor): - | 相机模式 |
| scanCode | Web: x; 微信小程序: 4.41; Android: 4.71; Android(Vapor): -; iOS: 4.71; iOS(Vapor): -; HarmonyOS: x; HarmonyOS(Vapor): - | 扫码模式 |

#### resolution 的属性描述

| 合法值 | 兼容性 | 描述 |
| :- |  :-: | :- |
| low | Web: x; 微信小程序: 4.41; Android: 4.61; Android(Vapor): -; iOS: 4.61; iOS(Vapor): -; HarmonyOS: x; HarmonyOS(Vapor): - | 低 |
| medium | Web: x; 微信小程序: 4.41; Android: 4.61; Android(Vapor): -; iOS: 4.61; iOS(Vapor): -; HarmonyOS: x; HarmonyOS(Vapor): - | 中 |
| high | Web: x; 微信小程序: 4.41; Android: 4.61; Android(Vapor): -; iOS: 4.61; iOS(Vapor): -; HarmonyOS: x; HarmonyOS(Vapor): - | 高 |

#### frame-size 的属性描述

| 合法值 | 兼容性 | 描述 |
| :- |  :-: | :- |
| small | Web: x; 微信小程序: 4.41; Android: 4.61; Android(Vapor): -; iOS: 4.61; iOS(Vapor): -; HarmonyOS: x; HarmonyOS(Vapor): - | 小尺寸帧数据 |
| medium | Web: x; 微信小程序: 4.41; Android: 4.61; Android(Vapor): -; iOS: 4.61; iOS(Vapor): -; HarmonyOS: x; HarmonyOS(Vapor): - | 中尺寸帧数据 |
| large | Web: x; 微信小程序: 4.41; Android: 4.61; Android(Vapor): -; iOS: 4.61; iOS(Vapor): -; HarmonyOS: x; HarmonyOS(Vapor): - | 大尺寸帧数据 |

#### photo-resolution 的属性描述

| 合法值 | 兼容性 | 描述 |
| :- |  :-: | :- |
| low | Web: x; 微信小程序: x; Android: 4.81; Android(Vapor): -; iOS: x; iOS(Vapor): -; HarmonyOS: x; HarmonyOS(Vapor): - | 低分辨率 |
| medium | Web: x; 微信小程序: x; Android: 4.81; Android(Vapor): -; iOS: x; iOS(Vapor): -; HarmonyOS: x; HarmonyOS(Vapor): - | 中分辨率 |
| high | Web: x; 微信小程序: x; Android: 4.81; Android(Vapor): -; iOS: x; iOS(Vapor): -; HarmonyOS: x; HarmonyOS(Vapor): - | 高分辨率 |
| original | Web: x; 微信小程序: x; Android: 4.81; Android(Vapor): -; iOS: x; iOS(Vapor): -; HarmonyOS: x; HarmonyOS(Vapor): - | 原始分辨率，相机的原始分辨率拍照质量最高，但是保存速度可能会较慢 |
