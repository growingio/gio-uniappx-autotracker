...
| 名称 | 类型 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| nodes | array \| string | - | Web: 4.0; 微信小程序: 4.41; Android: 3.9; Android(Vapor): -; iOS: 4.11; iOS(Vapor): -; HarmonyOS: 4.61; HarmonyOS(Vapor): 5.0 | 节点列表 \| HTML String |
| selectable | boolean | false | Web: 4.0; 微信小程序: 4.41; Android: 3.9; Android(Vapor): -; iOS: 4.11; iOS(Vapor): -; HarmonyOS: 4.61; HarmonyOS(Vapor): 5.0 | 文本是否可选 |
| mode | string | "web" | Web: x; 微信小程序: x; Android: 4.71; Android(Vapor): -; iOS: x; iOS(Vapor): -; HarmonyOS: x; HarmonyOS(Vapor): x | 渲染模式 |
| space | string | - | Web: x; 微信小程序: 4.41; Android: x; Android(Vapor): -; iOS: x; iOS(Vapor): -; HarmonyOS: x; HarmonyOS(Vapor): - | *(string)*<br/>显示连续空格 |
| ~~user-select~~ | boolean | - | Web: x; 微信小程序: 4.41; Android: x; Android(Vapor): -; iOS: x; iOS(Vapor): -; HarmonyOS: x; HarmonyOS(Vapor): - | *(boolean)*<br/>文本是否可选，该属性会使节点显示为 block。已废弃，请使用 selectable |
| @itemclick | (event: [UniRichTextItemClickEvent](#unirichtextitemclickevent)) => void | - | Web: 4.0; 微信小程序: x; Android: 3.9; Android(Vapor): -; iOS: 4.11; iOS(Vapor): -; HarmonyOS: 4.71; HarmonyOS(Vapor): 5.0 | 拦截点击事件（只支持 a、img标签），返回img标签的src属性或a标签的href属性。event.detail={ src \| href } |

#### mode 的属性描述

| 合法值 | 兼容性 | 描述 |
| :- |  :-: | :- |
| web | Web: x; 微信小程序: x; Android: 4.71; Android(Vapor): -; iOS: x; iOS(Vapor): -; HarmonyOS 系统版本: 6.0; HarmonyOS: x; HarmonyOS(Vapor): 5.0 | 使用webview渲染 |
| native | Web: x; 微信小程序: x; Android: 4.71; Android(Vapor): -; iOS: x; iOS(Vapor): -; HarmonyOS 系统版本: 6.0; HarmonyOS: x; HarmonyOS(Vapor): 5.0 | 使用原生渲染 |

#### space 的属性描述

| 合法值 | 兼容性 | 描述 |
| :- |  :-: | :- |
| ensp | Web: x; 微信小程序: 4.41; Android: x; Android(Vapor): -; iOS: x; iOS(Vapor): -; HarmonyOS: x; HarmonyOS(Vapor): x | 中文字符空格一半大小 |
| emsp | Web: x; 微信小程序: 4.41; Android: x; Android(Vapor): -; iOS: x; iOS(Vapor): -; HarmonyOS: x; HarmonyOS(Vapor): - | 中文字符空格大小 |
| nbsp | Web: x; 微信小程序: 4.41; Android: x; Android(Vapor): -; iOS: x; iOS(Vapor): -; HarmonyOS: x; HarmonyOS(Vapor): - | 根据字体设置的空格大小 |
...
<script setup lang="uts">
	...
	const testOpenDialogPage = () => {
		uni.openDialogPage({
			url: '/pages/component/rich-text/rich-text-dialog-page'
		});
	}
