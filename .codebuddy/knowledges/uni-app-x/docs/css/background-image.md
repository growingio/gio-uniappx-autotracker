...
| 名称 | 兼容性 | 描述 |
| :- | :- | :- |
| linear-gradient | Web: 4.0; Android: 3.9; Android(Vapor): 5.21; iOS: 4.11; iOS(Vapor): 5.11; HarmonyOS: 4.61; HarmonyOS(Vapor): 5.0 | 使用由两种或多种颜色沿一条直线进行线性过渡的背景图像。 |
| none | Web: 4.0; Android: 4.27; Android(Vapor): 5.21; iOS: 4.27; iOS(Vapor): 5.11; HarmonyOS: 4.61; HarmonyOS(Vapor): 5.0 | 表示无背景图 |
