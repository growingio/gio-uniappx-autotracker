...
hash: 0e2b1a9f0275a8b89716e26882c9d8df5e3e93c3907d1139c9614d39934cd0db
-->
...
手机端除了可以指挥AI外，还可以发布应用，比如把web版发布到uniCloud的前端网页托管，在手机上看效果。
...
有些开发者对此没有认知，大多是因为没有真的用过claude code + 原版opus。
...
- cc和codex都是锁定自家模型，而uni-agent是多模型切换，可以把简单的任务交给便宜的模型处理。
...
- 代码安全
	且不说代码的逻辑泄漏，更重要的是代码中的key，尤其是uniCloud代码中涉及身份和资金的key，这种信息传给中转站的非常危险。\
