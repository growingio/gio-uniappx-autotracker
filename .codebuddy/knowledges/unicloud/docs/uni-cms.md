...
> AI功能基于 `uni-ai-chat` 实现，`uni-ai-chat` 文档请参考[uni-ai-chat](https://doc.dcloud.net.cn/uniCloud/uni-ai-chat.html)。
>
...
### Q: invalid appid rid: xxxxx

这是因为开启了内容安全检测，但是没有正确配置微信小程序的appid和appsecret导致的，查看[内容安全检测文档](https://doc.dcloud.net.cn/uniCloud/uni-cms.html#content-security-check)关闭或配置内容安全检测
