...
### key权限配置说明@permission

如果提示来源域名未被授权，请按下图操作，去除域名白名单

**腾讯地图**

![](https://web-ext-storage.dcloud.net.cn/doc/api/choose-location/0a18e9ee-0d3d-4a8b-af6a-19f4a9ab30fc.png)

**高德地图**

![](https://web-ext-storage.dcloud.net.cn/doc/api/choose-location/b579e8fc-3f62-4a64-bfa1-f479ac9abe39.png)