...
- 插件市场导入的用法请参考[云函数公用模块](https://doc.dcloud.net.cn/uniCloud/cf-common)
...
|    openid     | String |                       用户 id                       |     -     |
|  tradeState   | String | 值 SUCCESS 时为支付成功，通常需要校验订单金额等参数 |      -    |
