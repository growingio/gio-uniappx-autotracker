...
- apk地址（发布在uniCloud的云存储上）
	* Hello uniCloud 支付宝云版地址：[apk下载](https://env-00jxu6sh23yx.normal.cloudstatic.cn/apk/__UNI__HelloUniCloud__20251016204548.apk)
	* Hello uniCloud 阿里云版地址：[apk下载](https://web-ext-storage.dcloud.net.cn/doc/unicloud/__UNI__HelloUniCloud_0113204611.apk)
...
1. 在 HBuilderX 新建项目界面，选择uni-app项目，选择 Hello uniCloud 项目模板。
	- 初次体验推荐支付宝云或阿里云，这两家厂商为用户提供了免费的服务空间。
...
2. HBuilderX 会在项目创建后弹出 uniCloud初始化向导，根据向导部署
	...
	**说明**
	...
	- 阿里云、支付宝云每个账号可以有一个开发者版免费空间，此空间资源较少仅能用于测试开发。腾讯云无免费空间。
