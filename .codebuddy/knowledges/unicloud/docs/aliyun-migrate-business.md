...
4. 云函数运行内存设的太高。正常情况下256M内存是够的。可以在[云函数package.json](https://doc.dcloud.net.cn/uniCloud/cf-functions.html#memory)或web控制台调整。
...
[App升级中心](https://doc.dcloud.net.cn/uniCloud/upgrade-center.html#upgrade-center-fee)

[短信](https://doc.dcloud.net.cn/uniCloud/sms/price)

[App一键登录](https://doc.dcloud.net.cn/uniCloud/uni-login/price)
