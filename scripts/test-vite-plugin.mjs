...

{
  ...
  const output = transform(code)
  assert.match(output, /@change="_gioAutoTrackDispatch\(\$event, 0, \$event\.detail\.value, null, null, null, null, null, null, conditionEnabled, 1\) \? onChangeTrue\(\$event\) : onChangeFalse\(\$event\)"/)
